...
import com.cibertec.examen.adaptador.UsuarioAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnLista;
    ListView listView;
    UsuarioAdapter adaptadorListView;
    ...
    public void listData(){
        Call<List<Usuario>> call = servicio.listaUsuario();
        call.enqueue(new Callback<List<Usuario>>() {
            ...
            public void onResponse(Call<List<Usuario>> call, Response<List<Usuario>> response) {
                if(response.isSuccessful()){
                    ...
                    list = response.body();
                    adaptadorListView = new UsuarioAdapter(MainActivity.this, R.layout.activity_list, list);
